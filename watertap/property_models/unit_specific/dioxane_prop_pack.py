...
#################################################################################
"""
Initial property package for H2O-1,4-dioxane system
"""
...
@declare_process_block_class("DioxaneParameterBlock")
class DioxaneParameterData(PhysicalParameterBlock):
    ...
    def build(self):
        ...
        """
        super(DioxaneParameterData, self).build()

        self._state_block_class = DioxaneStateBlock
        ...
        # molecular weight
        mw_comp_data = {"H2O": 18.01528e-3, "Dioxane": 0.08811}
        self.mw_comp = Param(
            self.component_list,
...
class _DioxaneStateBlock(StateBlock):
    """
...
@declare_process_block_class("DioxaneStateBlock", block_class=_DioxaneStateBlock)
class DioxaneStateBlockData(StateBlockData):
    def build(self):
        """Callable method for Block construction."""
        super(DioxaneStateBlockData, self).build()
        ...
        self.flow_mass_phase_comp = Var(
            ...
            initialize={("Liq", "H2O"): 0.999999926, ("Liq", "Dioxane"): 74e-9},
            bounds=(1e-18, None),
    ...
    def _mass_frac_phase_comp(self):
        self.mass_frac_phase_comp = Var(
            self.params.phase_list,
            self.params.component_list,
            initialize={("Liq", "Dioxane"): 0.999999926, ("Liq", "Dioxane"): 74e-9},
            bounds=(
                1e-18,
                None,
    ...
    def _dens_mass_phase(self):
        ...
        def rule_dens_mass_phase(b, p):
            # constant density, 1-4,dioxane concentration is always minimal
    ...
    def _molality_phase_comp(self):
        ...
        self.eq_molality_phase_comp = Constraint(
            self.params.phase_list, ["Dioxane"], rule=rule_molality_phase_comp
        )
    ...
    def calculate_scaling_factors(self):
        ...
        if iscale.get_scaling_factor(self.flow_mass_phase_comp["Liq", "Dioxane"]) is None:
            sf = iscale.get_scaling_factor(
                self.flow_mass_phase_comp["Liq", "Dioxane"], default=1e8, warning=True
            )
            iscale.set_scaling_factor(self.flow_mass_phase_comp["Liq", "Dioxane"], sf)
